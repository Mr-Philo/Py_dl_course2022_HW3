...
def _init_():
    ...
    os.system('cp eval_voting.py /output/heckpoints' + '/' + args.exp_name + '/' + 'eval_voting.py.backup')
...
def test(args, io):
    ...
    model.load_state_dict(torch.load("dgcnn_best_model.t7"))
    model = model.eval()
    best_acc = 0
...
if __name__ == "__main__":
    ...
    io = IOStream('/output/checkpoints/' + args.exp_name + '/%s_voting.log' % (args.exp_name))
    io.cprint(str(args))
